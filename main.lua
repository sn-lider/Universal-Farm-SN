...
-- CARGA DE LIBRERÍA
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/sn-lider/Universal-Farm-SN/refs/heads/main/main.lua", true))()

-- VENTANA PRINCIPAL
local window = library:AddWindow("🌐 Universal Farm by SN", {
    main_color = Color3.fromRGB(186, 85, 211), 
...
AutoFarm:AddSwitch("Anti AFK", function(state)
    if state then
        ...
        uselesslabelone.Text = "🌐 Universal AFK by SN"
...
-- 🚀 Anti Lag
RebirthFolder:AddButton("Dark mode", function()
...
AutoFarm:AddLabel("Farm NO Packs")
...
rebirthsFolder:AddTextBox("Rebirth Target", function(text)
    ...
    if newValue and newValue > 0 then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            ...
            Text = "Por favor ingresa un numero valido mayor que 0",
            Duration = 0
        })
    end
end)
...
local button = Killer:AddButton("congelar el agua", function()
    ...
    ocal WalkPart = Instance.new("Part")
    WalkPart.Parent = Game.Workspace
    WalkPart.Anchored = true
...
Credits:AddLabel("Universal Script by SN")
